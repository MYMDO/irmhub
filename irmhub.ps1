...
$script:CATALOG = @(
    ...
    [PSCustomObject]@{ Id=19; Name='WinGet-CLI (LTSC/LTSB)'; Cat='System';          Icon='[SYS]'; Admin=$true;  Cmd='irm https://raw.githubusercontent.com/gerardog/winget-installer/master/install.ps1 | iex';                                                                             GitHub='https://github.com/gerardog/winget-installer';             Desc='Install Microsoft WinGet on Windows 10/11 LTSC, LTSB, and Server versions.' }
)
