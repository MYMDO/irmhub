...
$script:CATALOG = @(
    ...
    [PSCustomObject]@{ Id=19; Name='Microsoft PowerToys';    Cat='System';          Icon='[SYS]'; Admin=$true;  Cmd='winget install --id Microsoft.PowerToys -e --source winget --accept-package-agreements --accept-source-agreements';                                                     GitHub='https://github.com/microsoft/PowerToys';                   Desc='System utilities to maximize productivity. Includes ColorPicker, FancyZones, Run, etc.' }
)
