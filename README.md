...
```
irmhub/
├── irmhub.ps1     # Головний застосунок (652 рядки)
...
|:--|:--------|------:|:--------|
| 1 | Constants | 71–88 | Версія, URL, коди виходу |
| 2 | Helper Functions | 90–198 | Безпека, консоль, форматування, пошук |
| 3 | Bootstrap & Security | 200–203 | TLS, ініціалізація консолі |
| 4 | State & UI Config | 205–237 | ANSI-кольори, категорійні кольори, ширина |
| 5 | Tool Catalog | 239–264 | Реєстр інструментів (19 шт.) + валідація ID |
| 6 | UI Components | 266–394 | Банер, список категорій, пошук, деталі |
| 7 | Execution Logic | 396–478 | Ізольоване виконання команд |
| 8 | Interactive Mode | 480–552 | Головний цикл TUI |
| 9 | Non-Interactive Mode | 554–630 | Обробка CLI-флагів |
| 10 | Main Entry Point | 632–652 | Маршрутизація режимів |
